<?php
function gradeQuiz($q1, $q2, $q3, $q4)
{
	$results = 0;
	...
	<!DOCTYPE html>
		...
		<body>
			<main>				
				...
				<p><a href="quiz_with_function.php">Take the quiz again!</a></p>
			</main>
		</body>
		</html>
...
<main>
	<h1>Take the quiz</h1>
	<form action="quiz_with_function.php" method="post">
		<fieldset>
